...
class AttackAwareFrontierTests(unittest.TestCase):
    def test_stern_floor_moves_screened_weight_above_old_prange_point(self):
        result = minimum_weight_for_stern_operation_floor(
            256,
            128,
            64.0,
            max_p=4,
    ...
    def test_attack_aware_full_kem_screen_known_point(self):
        ...
        self.assertEqual(candidate.stern_p, 3)
        self.assertEqual(candidate.stern_l, 12)
    ...
    def test_old_weight_thirty_does_not_pass_stern64(self):
        candidate = screen_attack_aware_kem_candidate(
            n=256,
            k=128,
            prange_trial_floor_bits=32.0,
