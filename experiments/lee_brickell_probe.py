...
def main() -> int:
    ...
    print("interpretation=transparent implementation-cost baseline; not modern ISD security bits")
    return 0 if p0_exact and p1_exact else 1
